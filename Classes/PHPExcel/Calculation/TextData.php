...
class PHPExcel_Calculation_TextData
{
    ...
    {
        $cs = str_split($c);
        if (ord($cs[0]) >=0 && ord($cs[0]) <= 127) {
            return ord($cs[0]);
        } elseif (ord($cs[0]) >= 192 && ord($cs[0]) <= 223) {
            return (ord($cs[0])-192)*64 + (ord($cs[1])-128);
        } elseif (ord($cs[0]) >= 224 && ord($cs[0]) <= 239) {
            return (ord($cs[0])-224)*4096 + (ord($cs[1])-128)*64 + (ord($cs[2])-128);
        } elseif (ord($cs[0]) >= 240 && ord($cs[0]) <= 247) {
            return (ord($cs[0])-240)*262144 + (ord($cs[1])-128)*4096 + (ord($cs[2])-128)*64 + (ord($cs[3])-128);
        } elseif (ord($cs[0]) >= 248 && ord($cs[0]) <= 251) {
            return (ord($cs[0])-248)*16777216 + (ord($cs[1])-128)*262144 + (ord($cs[2])-128)*4096 + (ord($cs[3])-128)*64 + (ord($cs[4])-128);
        } elseif (ord($cs[0]) >= 252 && ord($cs[0]) <= 253) {
            return (ord($cs[0])-252)*1073741824 + (ord($cs[1])-128)*16777216 + (ord($cs[2])-128)*262144 + (ord($cs[3])-128)*4096 + (ord($cs[4])-128)*64 + (ord($cs[5])-128);
        } elseif (ord($cs[0]) >= 254 && ord($cs[0]) <= 255) {
            // error
